...
class DiodeAlignmentCapability(BaseCapability):
    ...
    requires: List[str] = []  # No inputs needed - fully automatic
    ...
    async def execute(state: AgentState, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            return StateManager.store_context(
                state, registry.context_types.ALIGNMENT_CONTEXT, context_key, context
            )
    ...
    def _create_classifier_guide(self) -> Optional[TaskClassifierGuide]:
        ...
        return TaskClassifierGuide(
            ...
            examples=[
                ClassifierExample(
                    query="Align the diode", result=True, reason="Direct diode alignment request"
                ),
                ClassifierExample(
                ...
                ClassifierExample(
                    query="Scan energy", result=False, reason="Scanning - use bl531_scan"
                ),
            ],
