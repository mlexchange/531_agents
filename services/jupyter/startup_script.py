...
def print_environment_info():
    ...
    print(f"🌐 EPICS Gateway: {epics_addr}:{epics_port}")  # noqa: E231 - host:port format
...
try:
    ...
    logger.error(
        "Check sys.path and ensure the module 'services.ALS_assistant.agent_tools' "
        "and its dependencies (like nbformat) are accessible and installed."
    )
